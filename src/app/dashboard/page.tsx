...
import { PlusCircle, FileText, ChevronRight, MessageSquare, ArrowRight, Sparkles } from "lucide-react";
...
export default async function DashboardPage() {
    ...
    const totalResponses = forms.reduce((acc: number, form: any) => acc + form._count.responseSessions, 0);
    ...
    return (
        <div className="min-h-screen bg-[#f8fafc]">
            ...
            <div className="relative overflow-hidden bg-primary px-4 py-16 sm:px-6 lg:px-8 shadow-xl shadow-primary/10">
                ...
                <div className="relative mx-auto max-w-7xl">
                    ...
                    >
                        ...
                        <div className="flex gap-4">
                            <Button asChild size="lg" className="h-14 rounded-3xl bg-white text-primary hover:bg-blue-50 text-base font-black shadow-xl shadow-black/10 px-8 transition-all hover:scale-105 active:scale-95">
                                <Link href="/forms/new">
            ...
            <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                ...
                {forms.length === 0 ? (
                    <motion.div
                        ...
                        className="flex flex-col items-center justify-center rounded-3xl border-2 border-dashed border-primary/20 p-20 text-center bg-white shadow-sm"
                    >
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {forms.map((form: any, index: number) => (
                            ...
                            >
                                <Card className="group relative h-full overflow-hidden border-none bg-white shadow-sm transition-all hover:shadow-xl hover:-translate-y-2 rounded-3xl">
