...
import { PlusCircle, Search, Filter, MoreVertical, FileText, ChevronRight } from "lucide-react";
                ...
                <Card className="overflow-hidden border-none shadow-sm rounded-3xl bg-white">
                    <div className="flex items-center gap-4 border-b border-muted p-6">
                        <div className="relative flex-1">
                            ...
                            <Input placeholder="Search your forms..." className="pl-10 rounded-xl bg-muted/30 border-none h-11 focus-visible:ring-primary/20" />
                        </div>
                                    ...
                                    <TableRow>
                                        <TableCell colSpan={5} className="py-20 text-center">
                                            <div className="flex flex-col items-center">
                                                ...
                                                <p className="text-sm text-muted-foreground italic">Try adjusting your search or create a new one.</p>
                                            </div>
                                        </TableCell>
                                    </TableRow>
                                ) : (
